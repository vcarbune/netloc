...
gnuplot -e "filename='erdos_pb'; plottitle='Erdos-Renyi (MaxObservers=18%, N=100, Sources=20)'" ../script_pb.gnu
...
gnuplot -e "filename='erdos_avg_pb'; plottitle='Erdos-Reniy (MaxObservers=18%, N=100, Sources=20)'" ../script_avg_pb.gnu
...
# Average plots with yerrorbars for differences
gnuplot -e "filename='forest_avgdiff_pb'; plottitle='Forest Fire (MaxObservers=18%, N=100, Sources=50)'" ../script_avgdiff_pb.gnu
gnuplot -e "filename='forest_avgdiff_test'; plottitle='Forest Fire (MinMass=25%, N=100, Sources=50)'" ../script_avgdiff_tst.gnu
gnuplot -e "filename='barabasi_avgdiff_pb'; plottitle='Barabasi Albert (MaxObservers=18%, N=100, Sources=50)'" ../script_avgdiff_pb.gnu
gnuplot -e "filename='barabasi_avgdiff_test'; plottitle='Barabasi Albert (MinMass=25%, N=100, Sources=50)'" ../script_avgdiff_tst.gnu
gnuplot -e "filename='erdos_avgdiff_pb'; plottitle='Erdos-Reniy (MaxObservers=18%, N=100, Sources=50)'" ../script_avgdiff_pb.gnu
gnuplot -e "filename='erdos_avgdiff_test'; plottitle='Erdos-Reniy (MinMass=25%, N=100, Sources=50)'" ../script_avgdiff_tst.gnu

# Only yerrorbars to identify decrease in dimensionality (not really useful, because trend is visible in main graph)
#gnuplot -e "filename='forest_avgdiff_pb'; plottitle='Standard Error of Mass Concentration Plot (Forest Fire)'" ../script_yerror.gnu
#gnuplot -e "filename='forest_avgdiff_test'; plottitle='Standard Error of Min Observers Plot (Forest Fire)'" ../script_yerror.gnu
#gnuplot -e "filename='barabasi_avgdiff_pb'; plottitle='Standard Error of Mass Concentration Plot (Barabasi Albert)'" ../script_yerror.gnu
#gnuplot -e "filename='barabasi_avgdiff_test'; plottitle='Standard Error of Min Observers Plot (Barabasi Albert)'" ../script_yerror.gnu
#gnuplot -e "filename='erdos_avgdiff_pb'; plottitle='Standard Error of Mass Concentration Plot (Erdos-Reniy)'" ../script_yerror.gnu
#gnuplot -e "filename='erdos_avgdiff_test'; plottitle='Standard Error of Min Observers Plot (Erdos-Reniy)'" ../script_yerror.gnu
